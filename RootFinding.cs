...
namespace RF
{
    ...
    /// <summary>
    /// Contains three methods to find the root of a function.
    /// </summary>
    /// <remarks>
    ...
    public class RootFinding
    {
        ...
        (
            ...
            Func<double, double> f, // FunctionOfOneVariable
            double left,
            double right,
            double tolerance,   // suggested value = 1.0E-6
            double target       // typically 0.0, but it can be changed.
        )
        {
        ...
        (
            ...
            double left,
            double right,
            double tolerance,   // Typical value is 1.0E-6
            double target       // Typical value is 0.0
        )
        {
            // extra info that callers may not always want
            int iterationsUsed;
        ...
        (
            ...
            Func<double, double> f,         // FunctionOfOneVariable
            Func<double, double> fprime,    // FunctionOfOneVariable
            double guess,
            double tolerance,      // Typical value is 1.0E-6
            double target           // Typical value is 0.0
        )
